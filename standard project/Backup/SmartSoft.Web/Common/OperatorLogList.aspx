<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OperatorLogList.aspx.cs" Inherits="SmartSoft.Web.Data.OperatorLogList" %>
...
<body onload="javascript:SetGridViewScrolling('up1');__doPostBack('ToolBar1$lb_Search','');"
    ...
    <form id="form1" runat="server">
        ...
        <table class="TableSearch" id="TableSearch" cellpadding="0" cellspacing="0" style="margin: auto 0">
            ...
            <tbody id="searchMain">
                <tr>
                    ...
                    <td>
                        <asp:DropDownList runat="server" ID="SearcholOperatorID"></asp:DropDownList>
                    </td>
                     <th>
                        操作来源：
                    </th>
                    <td>
                        <asp:DropDownList runat="server" ID="ddlolOperateSource">
                    ...
                    <td>
                        <asp:TextBox ID="SearcholContent" runat="server"></asp:TextBox>
                    </td>
                    <th>
                        <input type="checkbox" id="cbID1" class="Checkbox" checked="true" onclick="ChangeTimeCommon(this, 'SearcholDateBegin','SearcholDateEnd');" />
                        操作时间：
                    </th>
                    <td>
                        <asp:TextBox ID="SearcholDateBegin" Width="100px" runat="server" CssClass="inputDate"></asp:TextBox>至
                        <asp:TextBox ID="SearcholDateEnd" Width="100px" runat="server" CssClass="inputDate"></asp:TextBox>
                    </td>
                </tr>
            </tbody>
        </table>
        <asp:UpdatePanel ID="up1" runat="server">
            <ContentTemplate>
                <asp:GridView ID="GridOperatorLog" runat="server" CssClass="Grid" GridLines="Both"
