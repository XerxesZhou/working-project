<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerBusinessAdd.aspx.cs" Inherits="SmartSoft.Web.Data.CustomerBusinessAdd" %>
            ...
            <div>
                <div data-role="page" id="divMainInfoView" style="height: 500px;">
                    ...
                    <asp:HiddenField ID="hfClueID" runat="server" Value="0"/>
                        <div>                        
                            <div id="divCustomerBusinessEdit" class="cssMainPanel" style=" width:100%;">
                                <table cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="inputDate" id="txtcbDate" placeholder="请选择日期" value='<%=DateTime.Now.ToString("yyyy-MM-dd")%>' />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>
