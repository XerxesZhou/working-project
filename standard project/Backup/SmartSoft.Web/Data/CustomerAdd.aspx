<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerAdd.aspx.cs" Inherits="SmartSoft.Web.Data.CustomerAdd" %>
                            ...
                            <div id="divCustomerEdit" class="cssMainPanel" style="width:100%;">
                                <table cellpadding="0" cellspacing="0">
                                    ...
                                    <tr class="trIsShowOpptunity">
                                        ...
                                        <td>
                                            <input type="text" class="inputDate" id="txtcoPredictFinishDate" placeholder="请选择日期" value='<%=DateTime.Now.ToString("yyyy-MM-dd")%>' />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>
