<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerReportAnalyse.aspx.cs" Inherits="SmartSoft.Web.Report.CustomerReportAnalyse" %>
...
<body style="overflow: visible;">
    <form id="form1" runat="server" defaultbutton="ToolBar1$lb_Search">
        ...
        <asp:UpdatePanel ID="up1" runat="server">
            <ContentTemplate>
                <asp:GridView ID="GridCustomerReportAnalyse" runat="server" CssClass="Grid" GridLines="Both"
