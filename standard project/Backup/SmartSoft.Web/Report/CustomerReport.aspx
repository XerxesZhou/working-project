<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerReport.aspx.cs" Inherits="SmartSoft.Web.Report.CustomerReport" %>
...
<body style="overflow: visible;">
    <form id="form1" runat="server" defaultbutton="ToolBar1$lb_Search">
                  ...
                  <tr>
                    ...
                    <td>
                       <asp:DropDownList ID="DropDownList1" runat="server">
                            ...
                            <asp:ListItem Value="E.ctName">按照客户类型统计</asp:ListItem>
                            <asp:ListItem Value="H.sName">按照客户状态统计</asp:ListItem>
                            <asp:ListItem Value="F.Name">按照客户来源统计</asp:ListItem>
        ...
        <asp:UpdatePanel ID="up1" runat="server">
            <ContentTemplate>
                <asp:GridView ID="GridCustomerReport" runat="server" CssClass="Grid" GridLines="Both"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="TongJiShuLiang" HeaderText="统计数量"  HtmlEncode="false" DataFormatString="{0:N0}">
                        </asp:BoundField>                               
                    </Columns>
                </asp:GridView>
