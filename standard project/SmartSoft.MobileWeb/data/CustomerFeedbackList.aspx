<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerFeedbackList.aspx.cs" Inherits="SmartSoft.MobileWeb.CustomerFeedbackList" %>
...
<head>
    ...
    <script type="text/javascript">
      ...
      function ViewCustomer(id) {
          window.location.href = "CustomerFeedbackEditForm.aspx?Action=View&ID=" + id;
      }

      FunctionName = "GetCustomerFeedbackDate";

      function getParameterStr(mode) {
      
          var cusKindID = $("#ddlCustomerFeedbackType").val();
      ...
      function getLiContent(item) {
          var li = "";
          li += '<li><a class="ui-btn ui-corner-all ui-shadow ui-btn-inline" onclick="ViewCustomer(' + item.cfbID + ')">';
          li += '<h3>';
          li += item.cusName + '</h3>';
          ...
          li += '<div class="ListLeft">';
          li += ' <div class="dis">';
          li += item.opeName + '|' + item.cfbAddDate + '</div>';
          li += '    </div>';
          li += '</div>';
          li += '</a>';
          li += '</li>';
            ...
            <div style="background-color:#fff">
                <table class="searchTable" id="SearchTable" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList runat="server" data-role="none" ID="ddlCustomerFeedbackType">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList runat="server" data-role="none" ID="ddlTableColumn">
                                ...
                                <asp:ListItem Text="反馈类型" Value="cfbFeedbackTypeID"></asp:ListItem>
                                <asp:ListItem Text="处理状态" Value="cfbStatusID"></asp:ListItem>
                                <asp:ListItem Text="处理人" Value="cfbHandleOperatorID"></asp:ListItem>
                                <asp:ListItem Text="录入人" Value="cfbAddOperatorID"></asp:ListItem>
                                <asp:ListItem Text="录入时间" Value="cfbAddDate" Selected="True"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
