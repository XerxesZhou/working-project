<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerEditForm.aspx.cs"
    Inherits="SmartSoft.Web.Data.CustomerEditForm" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function PutInOrGetFromCustomerPool() {
            ...
            <div>
                <div data-role="page" id="divMainInfoView" style="overflow: auto;">
                    ...
                    <div id="divTitle" data-role="header" data-theme="b" style="height: 80px; background-color: White;
                        ...
                        <div style=" width:50%; float:left;">
                            <div>
                                <ul id="MenuLi">
                                    <li>
                                        <a data-role="none" id="aChange" runat="server" class="MeunButton" onclick="javascript:TransCustomer();">转给他人</a>
                                    </li>
                                    <li>
                                        <a data-role="none" id="aPutInOrGetFromPool" runat="server" class="MeunButton" onclick="javascript:PutInOrGetFromCustomerPool();">认领</a>
                                    </li>
                                    <li>
                                        <a data-role="none" id="aDelete" runat="server" class="MeunButton" onclick="javascript:DeleteCustomer();">删除</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div id="div_Content" data-role="content" style="padding: 0px; overflow: auto; width: 100%;
                        ...
                        <asp:HiddenField ID="hfFirstLiLength" runat="server" value="11" />
                        <asp:HiddenField ID="hfPCWebDomain" runat="server" />
                        <asp:HiddenField ID="hfcfhOperatorID" runat="server" />
                        <div>
                            <%--转移给他人--%>
                            <div id="ShowddlChangeOperatorID" class="CssForTrans" >
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="OperatorButton" style="text-align: center;text-shadow: none;">
                                                    <a class="SavaBtn" style=" color:#fff; width:100%; float:left; cursor:pointer;" onclick="javascript:CloseThisDiv('ShowddlChangeOperatorID');">
                                                        取消</a>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <table style="background-color: #f8f8f8; line-height: 40px;">
                                        <tr>
                                            ...
                                            <td style="width: 50%; text-align: right;">
                                                <a onclick="javascript:ShowListCommon('divCustomerView','divCustomerEdit',this);">编辑</a>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                            ...
                            <div id="divFollowHistoryEdit" class="cssMainPanel">
                                <table cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <th>跟进时间：</th>
                                        <td><input type="text" class="inputDate2" id="cfhDate" placeholder="请选择日期"  /></td>
                                    </tr>
                                    <tr>
                                        <th>
                                           下次跟进：
                                        ...
                                        <td>
                                            <input type="text" class="inputDate2" id="txtcfhNextFollowTime" placeholder="请选择日期" value="")" />
                                        </td>
                                    </tr>
                            ...
                            <div id="divCoWorkerEdit" class="cssMainPanel">
                                <div class="new_div">
                                    <table style="background-color: #f8f8f8; line-height: 40px;">
                                        <tr>
                                            <td style="width: 100%;">
                                                <label class="cssEditlbl">可视区域</label>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                            ...
                            <div id="divOpptunityEdit" class="cssMainPanel">
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input  type="text" class="inputDate2"  id="txtcoDate" placeholder="请选择日期" value='<%=DateTime.Now.ToString("yyyy-MM-dd")%>' />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input  type="text" class="inputDate2"  id="txtcoPredictFinishDate" placeholder="请选择日期" value='<%=DateTime.Now.AddMonths(1).ToString("yyyy-MM-dd")%>' />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>
                            ...
                            <div id="divBusinessEdit" class="cssMainPanel">
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input  type="text" class="inputDate"  id="txtcbDate" value='<%=DateTime.Now.ToString("yyyy-MM-dd")%>' />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input  type="text" class="inputDate"  id="txtcbExpiredDate" value='<%=DateTime.Now.AddYears(1).ToString("yyyy-MM-dd")%>' />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>
                            ...
                            <div id="divReceiptPlanEdit" class="cssMainPanel">
                                <table cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="inputDate2" id="txtcrpDate" value='<%=DateTime.Now.ToString("yyyy-MM-dd HH:mm")%>' />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>
                            ...
                            <div id="divFollowPlanEdit" class="cssMainPanel">
                                <table cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <th>提醒时间：</th>
                                        <td>
                                            <input type="text" class="inputDate2" id="txtcfpDate" placeholder="请选择日期" value="")" />
                                        </td>
                                    </tr>
                                </table>
                                <div class="OperatorButton" style="text-align: center;text-shadow: none;">
