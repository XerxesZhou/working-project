...
<head id="Head1" runat="server">
    ...
    function Edit()
    {
        try
        {
            CheckBoxOpenWindowHandle("CustomerOpptunityPhaseEditForm.aspx?ID=",650,300, "请选择一条需要修改的记录!");
        }
        catch(err)
        {
        ...
        <asp:UpdatePanel ID="up1" runat="server">
            <ContentTemplate>
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="copName" HeaderText="名称" />
                    <asp:BoundField DataField="copRate" HeaderText="转化率" />
                    <asp:BoundField DataField="copOrderBy" HeaderText="顺序" />
                    <asp:BoundField DataField="copRemark" HeaderText="备注" />
                </Columns>
            </asp:GridView>
            </ContentTemplate>
            <Triggers>
