<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OpptunityReport.aspx.cs" Inherits="SmartSoft.Web.Report.OpptunityReport" %>
                  ...
                  <tr>
                    ...
                    <td>
                       <asp:DropDownList ID="DropDownList1" runat="server">
                            ...
                            <asp:ListItem Value="D.Name">按照来源统计</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <th>
                        显示类型：
            ...
            <ContentTemplate>
                <asp:GridView ID="GridOpptunityReport" runat="server" CssClass="Grid" GridLines="Both"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="TongJiShuLiang" HeaderText="统计金额"  HtmlEncode="false" DataFormatString="{0:N0}">
                        </asp:BoundField>                               
                    </Columns>
                </asp:GridView>
