<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectEditForm.aspx.cs"
    Inherits="SmartSoft.Web.Data.ProjectEditForm" %>
                    ...
                    <div id="divTitle" data-role="header" data-theme="b" style="height: 80px; background-color: White;
                        ...
                        <div style=" width:50%; float:left;">
                            <div>
                                <ul id="MenuLi">
                                    <li>
                                        <a data-role="none" id="aApprove" runat="server" onclick="javascript:ApproveProject();" class="MeunButton" >审核</a>
                                    </li>
                                    <li>
                                        <a data-role="none" onclick="javascript:DeleteProject();" class="MeunButton" >删除</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                    ...
                                    <table style="background-color: #f8f8f8; line-height: 40px;">
                                        <tr>
                                            ...
                                            <td style="width: 50%; text-align: right;">
                                                <a onclick="javascript:ShowListCommon('divProjectView','divProjectEdit',this);">编辑</a>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                            ...
                            <div id="divProjectEdit" class="cssMainPanel">
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox runat="server" placeholder="请输入名称（必填）" ID="txtpjNO"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox runat="server" placeholder="请输入公司名称（必填）" ID="txtpjCompanyName"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>
                                        ...
                                        <td>
                                            <asp:TextBox runat="server" placeholder="请输入项目配置（必填）" ID="txtpjDetail"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>
                                        ...
                                        <td>
                                            <asp:TextBox runat="server" placeholder="请输入产品型号（必填）" ID="txtpjProduct"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox runat="server" CssClass="inputDate" placeholder="请输入到期日期" ID="txtpjExpiredDate"></asp:TextBox>
                                        </td>
                                    </tr>
