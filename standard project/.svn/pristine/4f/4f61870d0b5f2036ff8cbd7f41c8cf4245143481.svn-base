...
(function ($) {
    $.fn.extend(
        ...
        function handleFixedTitle() {
     var options = {};
    options.width = (getContainerWidth() - 50) + "px";
    options.height = (getContainerHeight() - 10) + "px";
    $(".Grid").toSuperTable(options);
    $(".sData").parent().removeClass();
    $(".sData").parent().css("width", "100% !important");
    var w = $(".sData table").width();
    $(".sHeaderInner table").css("width", w);
}
