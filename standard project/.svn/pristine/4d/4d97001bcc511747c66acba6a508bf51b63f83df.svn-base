<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OperatorLogAnalyse.aspx.cs" Inherits="SmartSoft.Web.Report.OperatorLogAnalyse" %>
...
<body style="overflow: visible;">
    <form id="form1" runat="server" defaultbutton="ToolBar1$lb_Search">
        ...
        <asp:UpdatePanel ID="up1" runat="server">
            <ContentTemplate>
                <asp:GridView ID="GridOperatorLogAnalyse" runat="server" CssClass="Grid" GridLines="Both"
