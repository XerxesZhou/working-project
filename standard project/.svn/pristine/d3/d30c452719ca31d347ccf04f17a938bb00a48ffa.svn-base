<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerBusinessReport.aspx.cs" Inherits="SmartSoft.Web.Report.CustomerBusinessReport" %>
...
<body style="overflow: visible;">
    <form id="form1" runat="server" defaultbutton="ToolBar1$lb_Search">
            ...
            <tbody id="searchMain">
                  <tr>
                   ...
                   <th>
                    ...
                    <td>
                         <asp:DropDownList ID="SearchDepartmentID" runat="server" Width="60px">
                        </asp:DropDownList>
                    </td>
        ...
        <asp:UpdatePanel ID="up1" runat="server">
            <ContentTemplate>
                <asp:GridView ID="GridCustomerBusinessReport" runat="server" CssClass="Grid" GridLines="Both"
