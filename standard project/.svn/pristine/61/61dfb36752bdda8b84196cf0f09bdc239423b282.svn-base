<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeWorkReport.aspx.cs" Inherits="SmartSoft.Web.Report.EmployeeWorkReport" %>
...
<body  onload="javascript:SetGridViewScrolling('up1');"
    ...
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="up1" runat="server">
            <ContentTemplate>
                <asp:GridView ID="GridEmployeeWorkReport" runat="server" CssClass="Grid" GridLines="Both"
