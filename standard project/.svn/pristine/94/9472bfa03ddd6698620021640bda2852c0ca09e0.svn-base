<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerWorkReportAdd.aspx.cs"
    Inherits="SmartSoft.MobileWeb.data.CustomerWorkReportAdd" %>
        ...
        <div>
            <div>
                <div data-role="page" id="divMainInfoView" style="overflow: auto;">
                    ...
                    <div id="divBusinessView" class="cssMainPanel">
