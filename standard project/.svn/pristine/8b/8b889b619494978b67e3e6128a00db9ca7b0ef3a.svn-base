<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OpptunityReportAnalyse.aspx.cs" Inherits="SmartSoft.Web.Report.OpptunityReportAnalyse" %>
...
<body style="overflow: visible;">
    <form id="form1" runat="server" defaultbutton="ToolBar1$lb_Search">
                  ...
                  <tr>
                    ...
                    <td>
                       <asp:DropDownList ID="ddlType" runat="server">
                            <asp:ListItem Value="1">按照业务员统计</asp:ListItem>
                            <asp:ListItem Value="2">按照部门统计</asp:ListItem>
                            <asp:ListItem Value="3">按照来源统计</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <th>
                        名称：
        ...
        <asp:UpdatePanel ID="up1" runat="server">
            <ContentTemplate>
                <asp:GridView ID="GridOpptunityReportAnalyse" runat="server" CssClass="Grid" GridLines="Both"
