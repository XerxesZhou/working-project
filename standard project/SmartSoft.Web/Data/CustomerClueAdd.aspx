<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerClueAdd.aspx.cs" Inherits="SmartSoft.Web.Data.CustomerClueAdd" %>
            ...
            <div>
                <div data-role="page" id="divMainInfoView" style="height: 500px;">
                    ...
                    <asp:HiddenField ID="hfOpptunityID" runat="server"/>
                        ...
                        <div>                        
                            <div id="divCustomerClueEdit" class="cssMainPanel" style="width:100%;">
