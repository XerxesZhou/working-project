<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerFeedbackList.aspx.cs" Inherits="SmartSoft.Web.Data.CustomerFeedbackList" %>
...
<head id="Head1" runat="server">
    ...
    var EditFormUrl = "CustomerFeedbackEditForm.aspx";
    ...
    function ConvertToLink() {
        ConvertToLinkCommon("GridCustomerFeedback", "反馈类型");
    }
    </script>
</head>
<body onload="javascript:SetGridViewScrolling('up1');" style="overflow: visible;">
    <form id="form1" runat="server" defaultbutton="ToolBar1$lb_Search">
        ...
        <table class="TableSearch" id="TableSearch" cellpadding="0" cellspacing="0" style="margin: auto 0">
            ...
            <tbody id="searchMain">
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="SearchcfbFeedbackTypeID" runat="server"></asp:DropDownList>
                    </td>
                    <th>
                        关键字:
                    </th>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="SearchcfbOperatorID" runat="server"></asp:DropDownList>
                    </td>
                    <th>
                        状态:
                    </th>
                    <td>
                        <asp:DropDownList ID="SearchcfbStatusID" runat="server"></asp:DropDownList>
                    </td>
                    <th>
                        <input type="checkbox" id="cbID1" class="Checkbox" checked="true" onclick="ChangeTimeCommon(this, 'SearchcfbAddDateBegin','SearchcfbAddDateEnd');" />
                        录入时间：
                    </th>
                    <td>
                        <asp:TextBox ID="SearchcfbAddDateBegin" Width="100px" runat="server" CssClass="inputDate"></asp:TextBox>至
                        <asp:TextBox ID="SearchcfbAddDateEnd" Width="100px" runat="server" CssClass="inputDate"></asp:TextBox>
                    </td>
                </tr>
            </tbody>
        </table>
        <asp:UpdatePanel ID="up1" runat="server">
            <ContentTemplate>
                <asp:GridView ID="GridCustomerFeedback" runat="server" CssClass="Grid" GridLines="Both"
