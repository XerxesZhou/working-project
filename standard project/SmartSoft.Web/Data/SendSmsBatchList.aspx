<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendSmsBatchList.aspx.cs" Inherits="SmartSoft.Web.Data.SendSmsBatchList" %>
...
<body onload="javascript:SetGridViewScrolling('up1');" style="overflow: visible;">
    <form id="form1" runat="server" defaultbutton="ToolBar1$lb_Search">
        ...
        <table class="TableSearch" id="TableSearch" cellpadding="0" cellspacing="0" style="margin: auto 0">
            ...
            <tbody id="searchMain">
                <tr>
                    ...
                    <td>
                       <asp:TextBox ID="SearchSendStatus" runat="server"></asp:TextBox>
                    </td>
                    <th>
                        <input type="checkbox" id="cbID1" class="Checkbox" checked="true" onclick="ChangeTimeCommon(this, 'SearchAddDateBegin','SearchAddDateEnd');" />
                        录入时间：
                    </th>
                    <td>
                        <asp:TextBox ID="SearchAddDateBegin" Width="100px" runat="server" CssClass="inputDate"></asp:TextBox>至
                        <asp:TextBox ID="SearchAddDateEnd" Width="100px" runat="server" CssClass="inputDate"></asp:TextBox>
                    </td>
                    <th>
                        录入人:
                    </th>
                    <td>
                        <asp:DropDownList ID="SearchAddOperatorID" runat="server"></asp:DropDownList>
                    </td>
                </tr>
            </tbody>
        </table>
        <asp:UpdatePanel ID="up1" runat="server">
            <ContentTemplate>
                <asp:GridView ID="GridSendSmsBatch" runat="server" CssClass="Grid" GridLines="Both"
