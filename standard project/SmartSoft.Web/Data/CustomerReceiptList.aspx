<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerReceiptList.aspx.cs" Inherits="SmartSoft.Web.Data.CustomerReceiptList" %>
...
<head id="Head1" runat="server">
    ...
    var EditFormUrl = "CustomerBusinessEditForm.aspx?FromType=receipt&showPanel=divReceiptList&ctr=Receipt";
    function ConvertToLink() {
        ConvertToLinkCommon("GridCustomerReceipt", "客户名称");
    }
    </script>
</head>
    ...
    <form id="form1" runat="server" defaultbutton="ToolBar1$lb_Search">
        ...
        <table class="TableSearch" id="TableSearch" cellpadding="0" cellspacing="0" style="margin: auto 0">
            ...
            <tbody id="searchMain">
                  <tr>
                    <th>
                        <input type="checkbox" id="cbID2" class="Checkbox" checked="true" onclick="ChangeTimeCommon(this, 'SearchcrDateBegin','SearchcrDateEnd');" />
                        收款日期：
                    </th>
                    <td>
                        <asp:TextBox ID="SearchcrDateBegin" Width="100px" runat="server" CssClass="inputDate"></asp:TextBox>至
                        <asp:TextBox ID="SearchcrDateEnd" Width="100px" runat="server" CssClass="inputDate"></asp:TextBox>
                    </td>
                    ...
                    <td>
                         <asp:DropDownList ID="SearchcrOperatorID" runat="server">
                        </asp:DropDownList>
                    </td>
                    ...
                    <td>
                        <asp:DropDownList ID="SearchcrTypeID" runat="server">
                        </asp:DropDownList>
        ...
        <asp:UpdatePanel ID="up1" runat="server">
            <ContentTemplate>
                <asp:GridView ID="GridCustomerReceipt" runat="server" CssClass="Grid" GridLines="Both"
